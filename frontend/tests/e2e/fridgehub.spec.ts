...
const goToVerificationScreen = async (
  ...
  await page.getByLabel('Your full name').fill('Test Admin')
  ...
  await page.getByLabel('Phone number').fill(hasPhone ? '91234567' : '00000000')
  await page.getByLabel('Postal code').fill('529234')
  await page.getByLabel('Address').fill('Tampines Street 34')
  await page.getByLabel('Username').fill(`testadmin${Date.now()}`)
